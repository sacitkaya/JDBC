package DB_Testing.javaExceptionHandling;
...
public class TryWithResources_Catch
{
    ...
    /*NOT:
    Yukarıdaki kodda, dosya adı "example.txt" olan bir FileReader nesnesi ile sarılmış olan bir BufferedReader nesnesi oluşturuyoruz.
